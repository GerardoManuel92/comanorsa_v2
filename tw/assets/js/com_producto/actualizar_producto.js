...
var idPsat = $("#bi_clave").val();//////va a guardar la clave del producto no el ID
var clValidar = 1;
    ...
    $('#fileupload_pdf').fileupload({
        ...
        dataType: 'json',
            ...
            progressall: function (e, data) {
             ...
             $("#files_cfactpdf").html("<strong>La imagen se ha subido correctamente</strong>");
  ...
  $.ajax({
            ...
            success: function(result)
            {
              ...
              if ( result != null ) {
                  ...
                  $("#unidad").val( $("#idunidad").val() ).trigger('change');;
  ...
  $.ajax({
            ...
            success: function(result)
            {
              ...
              if ( result != null ) {
                  ...
                  $("#marca").val( $("#idmarca").val() ).trigger('change');;
  ...
  $.ajax({
            ...
            success: function(result)
            {
              ...
              if ( result != null ) {
                  ...
                  $("#categoria").val( $("#idcategoria").val() ).trigger('change');;
...
function vClave(vclave){
  ...
  if ( vclave != "" ) {
    ...
    $.ajax({
            type: "POST",
            dataType: "json",
            url: base_urlx+"ActProducto/vClave/",
            data:{clave:vclave, idpro:$("#idfolio").val() },
            cache: false,
            success: function(result)
            {
...
function showTags(){
  ...
  $.ajax({
            type: "POST",
            dataType: "json",
            url: base_urlx+"ActProducto/showTags/",
            data:{ idpro:$("#idfolio").val() },
            cache: false,
            success: function(result)
            {
              ...
              if ( result != null ) {
          		...
          		separar = result.tags.split(",");
          		view = "";

          		for (var i = 0; i < separar.length; i++) {
      
          			arrayTag.push( separar[i] );

			      	view = view+'<button onclick="retirarTag('+i+')" class="btn-red" style="border-radius: 10px; opacity: .8; margin-left:10px;"><i class="fa fa-close"></i> '+separar[i]+'</button>';
...
/*function altaTags(){
	...
	if ( $("#tag").val() != "" ) {
	    ...
	    $.ajax({
	            type: "POST",
	            dataType: "json",
	            url: base_urlx+"ActProducto/altaTags/",
	            data:{ idpro:$("#idfolio").val(), tagx:$("#tag").val() },
	            cache: false,
	            success: function(result)
	            {
		...
		alert("Alerta, favor de colocar un tag valido");
		$("#tag").focus();
  ...
  if ( verificar == 0 ) {
    ...
    $("#btn_finalizar").html("Ingresando producto...");
     ...
     $.ajax({
            type: "POST",
            dataType: "json",
            url: base_urlx+"ActProducto/actPartida/",
            data:{
            ...
            success: function(result)
            {
              ...
              if ( result ) {
                ...
                window.location.href=base_urlx+'Rproducto';
