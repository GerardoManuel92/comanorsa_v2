...
$(document).ready(function() {
    ...
    table = $('#my-table').DataTable({
        ...
        "ajax": base_urlx+"TestCotizacion/loadPartidas?idcot="+idcotx,
...
function showPDF(idcotxz,pedidox){
...

          {
            ...
            if(pedidox==1){
                ...
                $.ajax({
                      ...
                      data: { archivo:$("#name_factpdf").val(), cotizacion:idcotxz },
                      ...
                      { 
                        ...
                        if(result){
                          ...
                          alert("Error, el pedido no pdo ser creado");
...
function actCotizacion(pedidox){
...
function newCotizacion(){
  ...
  if (x) {
    ...
    subx = 0;
      ...
      subx = parseFloat(subx)+parseFloat(el["IDX"]);
