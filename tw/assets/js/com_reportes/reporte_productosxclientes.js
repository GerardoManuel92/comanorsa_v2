	  ...
	  if ( table !="" ) {
	    ...
	    $('#my-table').DataTable().destroy();
	      ...
	      "language": {
	        ...
	        "ajax": base_urlx+"Rproductosxcliente/loadProductos?idcliente="+$("#cliente").val(),
...
function showexcel() {
  ...
  /* alert( $("#cliente").val()); */
	...
	$.ajax({
		...
		url: base_urlx + "tw/php/crear_excel_productos_x_cliente.php",
		...
		success: function (result) {
			if (result) {
				window.location.href = base_urlx + "tw/php/reporte/reporte_productos_clientes.xlsx";
        alert("Creando excel");
			} else {
