...
function showOdc(){
    ...
    $.ajax({
            ...
            url: base_urlx+"Vseguimiento/showOdc/",
...
function loadEntregas() {
  $.ajax({
    type: "POST",
    dataType: "json",
    url: base_urlx+"Vseguimiento/loadEntregas/",
    data:{ idcot:idcotx },
    cache: false,
    success: function(result)
    {
...
function showFactura(){
    ...
    $.ajax({
      type: "POST",
      dataType: "json",
      url: base_urlx+"Vseguimiento/showFactura/",
      data:{ idcot:idcotx },
      cache: false,
      success: function(result)
      {
...
function verOdcCliente(){
  ...
  $.ajax({
            ...
            url: base_urlx+"Vseguimiento/verOdcCliente/",
...
function showExcel(idcotx) {
  ...
  $.ajax({
    ...
    url: base_urlx + "tw/php/crear_excel_seguimiento_entrega.php",

    data: { cotizacionx : idcotx},
    ...
    success: function (result) {
      ...
      if (result) {
        ...
        window.location.href = base_urlx + "tw/php/reporte/Seguimiento_ventas/";
...
$(document).ready(function() {
	...
	table = $('#my-table').DataTable({
        ...
        "ajax": base_urlx+"Vseguimiento/loadPartidas?idcot="+idcotx,
