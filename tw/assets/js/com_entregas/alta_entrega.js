  ...
  cell.addEventListener('blur', function(e) {
    ...
    if (original !== e.target.textContent) {
      ...
      if ( colx == 0 ) {
        ...
        if ( cant_entrada > -1 && cant_almacen > 0 ) {
...
function showInfo(){
  ...
  $.ajax({
            ...
            url: base_urlx+"Centrega/showInfo/",
              ...
              if ( result != null ) {
                ...
                if ( $("#tipo").val() == 1 ){
                  ...
                  if ( result.estatus == 0 ) {
                    ...
                    $('#formato').attr('href', base_urlx+"tw/php/remisiones/rem"+$('#folio').val()+".pdf");



                    $("#fecha").html( 'Realizada: '+fechaenLetra(result.fecha) );

                    $("#observaciones").html('Observaciones: '+result.observaciones);
                    ...
                    alert("Alerta, la REMISION ha sido entregada por completo");
  ...
  if ( getFolio($("#folio").val()) > 0 ) {
    ...
    table = $('#my-table').DataTable({
        ...
        "language": {
                 ...
                 render: function ( data, type, row, meta ) {                   
                  ...
                  /*return `<button class="btn btn-danger hidden-xs" type="button" title="Borrar" onclick="borrarArticulo(${row[4]})"> <i class="icon-trash"></i> </button><button class="btn btn-orange hidden-xs" type="button" title="Editar" onclick="editarArticulo(${row[4]})"> <i class="icon-pencil"></i> </button><div class="dropdown open hidden-sm hidden-md hidden-lg hidden-xl">
                    ...
                    */
                    ...
                    // Reasignado
                    valor2=calcularSubtotal( data[5],data[6],data[7],data[8] );
          ...
          "ajax": base_urlx+"Centrega/loadPartidas?tipox="+$("#tipo").val()+"&iddoc="+$("#folio").val(),
  ...
  if ( x ) {
    ...
    verificar = 0;
      ...
      $('#my-table').DataTable().rows().data().each(function(el, index){
        ...
        total_entregas = parseFloat(total_entregas)+parseFloat(centrega);
        ...
        cvalor = codc+"/"+centrega+"/"+cidentrega;
      ...
      if ( verificar == 0 ) {
        ...
        $("#btn_parcial").html('Almacenando...');
          ...
          $.ajax({
                ...
                url: base_urlx+"Centrega/entradaParcial/",
      ...
      $('#my-table').DataTable().rows().data().each(function(el, index){
        ...
        $("#btn_all").html('Almacenando...');
          ...
          $.ajax({
                ...
                url: base_urlx+"Centrega/entradaAll/",
