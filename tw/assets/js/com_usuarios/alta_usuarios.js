		...
		$.ajax({
			...
			success: function (result) {
				if (result > 0) {
					...
					alert("Alerta, el usuario ya ha sido registrado");
					location.reload();
				} else {
					alert(
		...
		$.ajax({
			...
			success: function (result) {
				...
				if (result == true) {
					...
					alert(
						"El nombre de usuario ya existe, prueba con uno diferente"
					);
				}
				else if(result == 0){
					alert(
		...
		success: function (result) {
			if (result != null) {
				...
				$.each(result, function (i, item) {
					...
					div +=
						'<div class="col-md-12 col-lg-12" style="border-radius : 3px; border: 1px solid black; margin-top: 10px;"><div class="card border ' +
						bordercolor +
						'"><div class="card-header border-primary"><h5 class="my-0 ' +
						txtcolor +
