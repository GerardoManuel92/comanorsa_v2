...
function showUsers(){
    ...
    $.ajax({
            ...
            url: base_urlx+"Ajustesalida/showUsers/",
...

            {
              ...
              if ( result != null ) {
                  ...
                  var creaOption="<option value='0' selected>Selecciona un usuario...</option>"; 
                 ...
                 $("#usuario").html("<option value='0'>Sin categorias</option>");
  ...
  ///////////primera imagen  
    ...
    table = $('#my-table').DataTable({
      ...
      "language": {
        ...
        "ajax": base_urlx+"Rsalidaxajuste/loadPartidas?idus="+$("#usuario").val() + "&statusx=" + $("#bestatus").val(),
...
function showPartidas(identradax){
    ...
    $.ajax({
            ...
            url: base_urlx+"Rsalidaxajuste/showPartidas/",
...
function showExcel() {
  ...
  $.ajax({
    ...
    url: base_urlx + "tw/php/crear_excel_salidas_x_ajuste.php",

    data: { usuariox: $("#usuario").val(), statusx : $("#bestatus").val() },
    ...
    success: function (result) {
      ...
      if (result) {
        ...
        window.location.href = base_urlx + "tw/php/reporte/reporte_salidas_x_ajuste.xlsx";
...
function cancelarAjuste(ID,ID2) {
  ...
  if (respuesta) {
    ...
    $.ajax({
      ...
      url: base_urlx+"Rsalidaxajuste/cancelarAjuste/",
