  ...
  ////////////////************ TABLA 
    ...
    table = $('#my-table').DataTable({
      ...
      "language": {
        ...
        "ajax": base_urlx+"Ajustesalida/loadPartidas?iduser="+iduserx,
...
function ingresarPartidas(){
  ...
  if ( verificar == 0 ) {
    ...
    $.ajax({
            ...
            url: base_urlx+"Ajustesalida/ingresarPartidas/",
...
function retirarParte(idpartex,torden){
  ...
  if ( x ) {
    ...
    $.ajax({
            ...
            url: base_urlx+"Ajustesalida/retirarParte/",
...
function finalizarEntrada(){
  ...
  x = confirm("¿Realmente deseas finalizar el ajuste de salida?");
  ...
  */
    if ( verificar == 0 ) {
      ...
      $.ajax({
            ...
            url: base_urlx+"Ajustesalida/finalizarAjuste/",
...

            {
              ...
              if ( result > 0 ) {
                ...
                alert("Alerta, la salida fue ingresada CORRECTAMENTE");
                showPDF(result);
                location.reload();
...
function showPDF(ajuste){
  ...
  $.ajax({
      ...
      url: base_urlx+"tw/php/pdf_ajuste_salida.php",
