...
{ 
    ...
    public function GeneraContenido(  
        ...
        $this->MultiCell(120, 3, utf8_decode("**Vigencia: ".$dias." días hábiles del mes en curso o hasta agotar existencias."), 0, 'L', 0); ///////importe con letra
...
$query = 'SELECT a.fcotizacion, a.observaciones, b.nombre AS cliente, b.comercial, c.nombre AS vendedor,b.calle,b.colonia,b.exterior,b.interior,b.municipio,b.estado,b.cp, CONCAT_WS(" / ",b.telefono,b.celular) AS telefonos,b.correo,d.descripcion AS fpago,b.rfc,a.moneda,a.tcambio
...
$exterior = $row2["exterior"];
$interior = $row2["interior"];
