    ...
    */
    ...
    switch ($fpagox) {
        ...
        default:
            ...
            $pagos_xml = '<pago20:Pago FechaPago="'.$fecha_pago.'" FormaDePagoP="'.$row_datos['clave'].'" MonedaP="'.$row_datos['monedax'].'" Monto="'.$row_datos['total'].'" TipoCambioP="1" NumOperacion="'.$row_datos['noperacionx'].'" >';
