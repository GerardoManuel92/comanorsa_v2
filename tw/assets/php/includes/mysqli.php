...
class sql_db
{
	...
	// Other query methods
	//
		function sql_prepare($query = "", $transaction = FALSE)
	{
					$this->query_result = mysqli_prepare( $this->db_connect_id,$query);
							if($this->query_result)
		{
			//unset($this->row[$this->query_result]);
			//unset($this->rowset[$this->query_result]);
    ...
    /* store result */
    mysqli_stmt_store_result($query_id);
			$result = mysqli_stmt_num_rows($query_id);
			return $result;
		}
		else
		{
	...
	function sql_numfields($query_id = 0)
	{
		...
		if($query_id)
		{
			$result = mysqli_field_count($this->db_connect_id);
			return $result;
		}
		else
		{
