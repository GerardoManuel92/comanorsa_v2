...
$objPHPExcel = $objReader->load("plantilla/plantilla_proveedores.xlsx");
...
if(strlen($texto) > 0){
  ...
  $sql = "SELECT a.id,a.nombre,a.comercial,a.rfc,b.descripcion AS fpago, c.descripcion AS cfdi, a.estatus, 
  
  CONCAT_WS(' ', a.calle, a.exterior, a.interior, a.colonia, a.municipio, a.estado, a.cp) AS direccion, a.dias, a.limite 
  
  FROM alta_proveedores a, sat_catalogo_fpago b, sat_catalogo_cfdi c 
  
  WHERE a.idfpago=b.id 
...
$objWriter->save('reporte/reporte_proveedores.xlsx');
