...
{ 
    ...
    function Header(){
        ...
        $this->SetY(48);$this->SetX(14); $this->MultiCell(25,2,"Forma de pago: ",0,'L',0);///////TITULO
        $this->SetY(48);$this->SetX(82); $this->MultiCell(25,2,"Metodo de pago: ",0,'L',0);///////TITULO
        ...
        $this->SetY(42);$this->SetX(28); $this->MultiCell(170,2,strtoupper( $direccion ),0,'L',0);///////TITULO
        $this->SetY(37);$this->SetX(66); $this->MultiCell(110,2,strtoupper($cliente.'|'.$comercial ),0,'L',0);///////TITULO

        $this->SetY(48);$this->SetX(36); $this->MultiCell(40,2,$fpago,0,'L',0);///////TITULO
        $this->SetY(48);$this->SetX(105); $this->MultiCell(88,2,utf8_decode("Pago en una sola exhibición"),0,'L',0);///////TITULO
    ...
    public function GeneraContenido(  
        ...
        $this->MultiCell(120, 3, letras2($total,$infomoneda), 0, 'L', 0); ///////importe con letra

        $this->SetFont('Arial', '', 7);
        $this->SetTextColor(27, 97, 218);
        $this->SetY(265);
        $this->MultiCell(120, 3, utf8_decode("**Vigencia: 5 días hábiles del mes en curso o hasta agotar existencias."), 0, 'L', 0); ///////importe con letra


        ////////************** AVCTUALIZAR LOS IMPORTES DE LA COTIZACION ACTUALIZADA Y LA NUEVA FACTURA
        ...
        ///////***
        $sql_upt="UPDATE alta_factura SET subtotal='".$suma_subtotal."', descuento='".$suma_descuento."', iva='".$suma_iva."', total='".$total."' WHERE idcotizacion=".$idcot;
        $db->sql_query($sql_upt);
...
$idcot =trim($_POST["idcot"]);

$query = 'SELECT a.fcotizacion, a.observaciones, b.nombre AS cliente, b.comercial, c.nombre AS vendedor,CONCAT_WS(",",b.calle,b.colonia,b.exterior,b.interior,b.municipio,b.estado,b.cp) AS direccion, CONCAT_WS(" / ",b.telefono,b.celular) AS telefonos,b.correo,d.descripcion AS fpago,b.rfc,a.moneda,a.tcambio
