...
{ 
    ...
    public function GeneraContenido(  
        ...
        $xml = simplexml_load_file('acuse_cancelacion_cpp/acuse'.$folio_fact.'.xml');
...
//$folio_fact = "A7055";
$idfactura=trim($_POST["idfactura"]);//IDCPP
...
$nombrearchivo = "facturas_canceladas_cpp/cancelacion_".$folio_fact.".pdf";
