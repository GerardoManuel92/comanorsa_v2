...
$objPHPExcel = $objReader->load("plantilla/plantilla_entradas_x_ajuste.xlsx");

$objPHPExcel->setActiveSheetIndex(0); //seleccionar hora

$objPHPExcel->getActiveSheet()->setTitle("ENTRADAS_POR_AJUSTE"); //establecer titulo de hoja
...
$sql = "SELECT nombre FROM alta_proveedores WHERE id='" . $proveedor . "'";
...
if ($proveedor == 0 && $statusx == 2){
  ...
  $sql2 = "SELECT a.id,a.fecha,a.total,b.nombre AS almacenista, c.nombre AS proveedor, CONCAT_WS('/',a.id,a.estatus) AS acciones, a.estatus, a.observaciones as motivo, a.documento   
...
while ($row2 = $db->sql_fetchrow($buscar2)) {
  ...
  $objPHPExcel->getActiveSheet()->SetCellValue("G$numFila", $almacenistax);
...
$objWriter->save('reporte/reporte_entradas_x_ajuste.xlsx');
