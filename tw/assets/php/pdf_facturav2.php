...
{ 
    ...
    function Header(){
        ...
        $this->SetY(28);$this->SetX(40); $this->MultiCell(85,3,utf8_decode($regimen_fiscal),0,'C',0);///////TITULO
        ...
        $this->SetDrawColor(0,0,0);
        $this->SetY(14);$this->SetX(128); $this->MultiCell(72,1,utf8_decode("FACTURA"),0,'C',0);///////TITULO
    ...
    public function GeneraContenido(  
        ...
        $this->Image('xml_qr/'.$folio.'.png',11,222,16,16,"PNG","http://comanorsa.com/");
        //$this->Image("logo_icono.png",14,14,21,18,"PNG","http://comanorsa.com/");
...
FROM alta_factura x,alta_cotizacion a, alta_clientes b, alta_usuarios c, sat_catalogo_fpago d, sat_metodo_pago e, sat_catalogo_cfdi f, folio_factura g
WHERE
x.idcotizacion=a.id
...
$sql_info = "SELECT comercial,rfc,razon_social,direccion,regimen FROM `datos_generales` WHERE estatus = 0";
...
$regimen_fiscal = utf8_decode($row_info["regimen"]);
