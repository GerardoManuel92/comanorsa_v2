...
$idfact =870;//trim($_POST["idfactura"]);

$query = 'SELECT x.ftimbrado,x.ftimbrado,x.htimbrado,x.moneda,x.tcambio,x.cadena,x.dias,x.idcotizacion,
a.fcotizacion, a.observaciones, b.nombre AS cliente, b.comercial, c.nombre AS vendedor,h.calle,h.exterior,h.colonia,h.interior,h.municipio,h.estado,h.cp, 
