...
{ 
    ...
    public function GeneraContenido(  
        ...
        if ( $valory > 182 ) {
            ...
            $this->SetX(12);$this->MultiCell(180,2,"Documentos relacionados:",0,'L',0);

            $this->SetY($last_y+101);

            $this->SetX(12);$this->MultiCell(180,2,"Tipo de relacion: 04 Sustitucion de los cfdi previos  |  UUID:".$uuid_previo,0,'L',0);

            $this->SetFont('Arial', 'B', 7);

            $this->SetY($last_y+108);
...
e.descripcion AS mpago,f.descripcion AS cfdi, CONCAT_WS("",g.serie,g.folio) AS folfactura, i.uuid AS uuid_previo
FROM alta_factura x, alta_clientes b, alta_usuarios c, sat_catalogo_fpago d, sat_metodo_pago e, sat_catalogo_cfdi f, folio_factura g, direccion_clientes h, alta_factura i
WHERE
x.idcliente=b.id
...
$uuid_previo=trim($row2["uuid_previo"]);
