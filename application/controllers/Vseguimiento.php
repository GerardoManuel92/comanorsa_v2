...
class Vseguimiento extends CI_Controller
        ...
        if ( $verificar_menu > 0 ) {
            ...
            if($iduser > 0){
                ...
                $dmenu["nommenu"] = "seguimiento"; 
                    ...
                    $this->load->view('reportes/seguimiento_ventas',$info_doc);

                    $this->load->view('general/footer');

                    $this->load->view('reportes/acciones_seguimiento_ventas',$info_doc);
