...
class Rfacturas extends CI_Controller

{
...

  {
    ...
    if ($verificar_menu > 0) {
      ...
      if ($iduser > 0) {
        ...
        $this->load->view('facturas/reporte_facturas');

        $this->load->view('general/footer');

        $this->load->view('facturas/accciones_reporte_facturas');
      } else {
  ...
  public function enviarCorreo()
  {
    ...
    if ($copiax == 1) {
      ...
      if ($contacto3x != "") {
        ...
        $this->email->cc(CORREOFACTURAS . ',' . $contacto3x);
      } else {
      ...
      if ($contacto3x != "") {
        ...
        $this->email->cc(CORREOFACTURAS . ',' . $otro_correox . ',' . $contacto3x);
      } else {
  ...
  public function loadFiltroCancelar()
  {
    ...
    /*SELECT g.id,a.uuid,CONCAT_WS('',g.serie,g.folio) AS foliox,a.total

        FROM alta_factura a, alta_clientes b, folio_factura g
        ...
        AND CONCAT_WS(a.total,b.nombre,b.comercial,g.folio,a.uuid) like '%".$data_post['buscarx']."%' AND a.estatus = 1

        UNION ALL

        SELECT g.id,a.uuid,CONCAT_WS('',g.serie,g.folio) AS foliox,a.total

        FROM alta_factura_sustitucion a, alta_clientes b, folio_factura g
    ...
    $sql = "SELECT g.id,a.uuid,CONCAT_WS('',g.serie,g.folio) AS foliox,a.total
...

  {
    ...
    $table = "(SELECT a.id,a.ftimbrado, CONCAT_WS('/',a.id,a.estatus,a.idcotizacion,'1',a.odc) AS acciones, c.nombre AS vendedor, b.nombre AS cliente, a.estatus, b.id AS idclientex,
            ...
            SELECT a.id,a.ftimbrado, CONCAT_WS('/',a.id,a.estatus,a.idcotizacion,'4',a.odc) AS acciones, c.nombre AS vendedor, b.nombre AS cliente, a.estatus, b.id AS idclientex,
    ...
    $columns = array(
      ...
      array(
        ...
        'formatter' => function ($d, $row) {
          ...
          if ($this->session->userdata(PUESTOCOM) == 3 or $this->session->userdata(PUESTOCOM) == 4) {
                ...
                return '<div class="btn-group">
                                      ...
                                      <span class="caret"></span>
                                        ...
                                        <ul class="dropdown-menu">
                                          ...
                                          <li><a href="javascript:cambiarEstatus(' . $separar[0] . ',1)" target="_blank" style="color:red; font-weight:bold;"><i class="fa fa-cancel" style="color:red; font-weight:bold;"></i> Cancelar</a></li>
                ...
                $info = '<div class="btn-group">
                                      ...
                                      <span class="caret"></span>
                                        ...
                                        <ul class="dropdown-menu">
                                          ...
                                          <li><a href="' . base_url() . 'Vseguimiento/infoVenta/' . $separar[2] . '" target="_blank" style="color:darkgreen; font-weight:bold;"><i class="fa fa-eye" style="color:darkgreen; font-weight:bold;"></i> Seguimiento</a></li>';



                if ($separar[4] != "") {

                  $info .= '<li><a href="' . base_url() . 'tw/js/odc_cliente/' . $separar[4] . '" target="_blank" style="color:purple; font-weight:bold;"><i class="fa fa-eye" style="color:purple; font-weight:bold;"></i> Ver ODC cliente</a></li>';
                }



                $info .= '<li><a href="' . base_url() . 'Altancredito/showFactura/' . $separar[0] . '" target="_blank" style="color:darkgreen; font-weight:bold;"><i class="fa fa-file-text-o" style="color:darkgreen; font-weight:bold;"></i> Aplicar Nota de credito</a></li>



                                          <li><a href="' . base_url() . 'Ncreditodesc/showFactura/' . $separar[0] . '" target="_blank" style="color:darkgreen; font-weight:bold;"><i class="fa fa-file-text-o" style="color:darkgreen; font-weight:bold;"></i> Aplicar Nota de descuento</a></li>
                                          ...
                                          <li><a href="#" data-toggle="modal" data-target="#modal_cancelar" style="color:red; font-weight:bold;"><i class="fa fa-cancel" style="color:red; font-weight:bold;"></i>Cancelar factura</a></li>
                                          ...
                                          <li><a href="javascript:verEstatus(' . $separar[0] . ',' . $separar[3] . ')" style="color:blue; font-weight:bold;"><i class="fa fa-eye"></i> Ver estatus</a></li>
                ...
                return '<div class="btn-group">
                                      ...
                                      <span class="caret"></span>
                                        ...
                                        <ul class="dropdown-menu">
                                          ...
                                          <li><a href="' . base_url() . 'CrearFactura/Factura/' . $separar[0] . '" target="_blank" style="color:darkgreen; font-weight:bold;"><i class="fa fa-file-text-o" style="color:darkgreen; font-weight:bold;"></i> Añadir factura</a></li>
      ...
      array(
        ...
        'formatter' => function ($d, $row) {
          ...
          if ($d == null) {
            ...
            return '<p><a href="mailto:' . $separar[0] . '"><i class="fa fa-envelope"></i> ' . $separar[0] . '</a></p><p><a href="tel:' . $separar[1] . '"><i class="fa fa-phone"></i> ' . $separar[1] . '</a></p>';
          }
        }
      ...
      array(
        ...
        'formatter' => function ($d, $row) {
          ...
          return "<p style='font-weight:bold;'>" . wims_currency($separar[3]) . "</p>";
        }
...

  {
    ...
    $table = "(SELECT a.id,a.ftimbrado, CONCAT_WS('/',a.id,a.estatus,a.idcotizacion,g.serie,g.folio,'1',a.odc) AS acciones, c.nombre AS vendedor, b.nombre AS cliente, a.estatus, b.id AS idclientex,
            ...
            AND CONCAT_WS('',a.total,b.nombre,b.comercial,g.serie,g.folio,a.uuid,a.idcotizacion,a.no_odc) like '%" . $data_get['buscar'] . "%'
            ...
            AND CONCAT_WS('',a.total,b.nombre,b.comercial,g.serie,g.folio,a.uuid,a.idcotizacion) like '%" . $data_get['buscar'] . "%'
    ...
    $columns = array(
            ...
            switch ($separar[1]) {
              ...
              case 1:
                ...
                if ($separar[6] != "") {
                  ...
                  $info .= '<li><a href="' . base_url() . 'tw/js/odc_cliente/' . $separar[6] . '" target="_blank" style="color:purple; font-weight:bold;"><i class="fa fa-eye" style="color:purple; font-weight:bold;"></i> Ver ODC cliente</a></li>';
                }
                ...
                $info .= '<li><a href="' . base_url() . 'Altancredito/showFactura/' . $separar[0] . '" target="_blank" style="color:darkgreen; font-weight:bold;"><i class="fa fa-file-text-o" style="color:darkgreen; font-weight:bold;"></i> Aplicar Nota de credito</a></li>
                                          ...
                                          <li><a href="javascript:verEstatus(' . $separar[0] . ',' . $separar[5] . ')" style="color:blue; font-weight:bold;"><i class="fa fa-eye"></i> Ver estatus</a></li>
                ...
                return '<div class="btn-group">
                                      ...
                                      <span class="caret"></span>
                                        ...
                                        <ul class="dropdown-menu">
                                          ...
                                          <li><a href="' . base_url() . 'tw/php/facturas_canceladas/cancelacion_' . $separar[3] . '' . $separar[4] . '.pdf" target="_blank" style="color:red; font-weight:bold;"><i class="fa fa-eye" style="color:red; font-weight:bold;"></i> Ver acuse</a></li>
      ...
      /*array( 'db' => 'pagos',     'dt' => 8,
                        ...
                        'formatter' => function( $d, $row ) {
                          ...
                          return "<p>Fpago:".$separar[0]."</p><p>Mpago:".$separar[1]."</p>";
...

  {
    ...
    if ($estatus == 6) {
      ...
      $table = "(SELECT a.id,a.ftimbrado, CONCAT_WS('/',a.id,a.estatus,a.idcotizacion,g.serie,g.folio,'1',a.odc) AS acciones, c.nombre AS vendedor, b.nombre AS cliente, a.estatus, b.id AS idclientex,
            ...
            AND CONCAT_WS('',a.total,b.nombre,b.comercial,g.serie,g.folio,a.uuid,a.idcotizacion,a.no_odc) like '%" . $busquedax . "%'
            ...
            AND CONCAT_WS('',a.total,b.nombre,b.comercial,g.serie,g.folio,a.uuid,a.idcotizacion) like '%" . $busquedax . "%'
  ...
  public function loadFiltroEstatus()

  {
    ...
    if ($data_get['estatus'] == 6) {
      ...
      $table = "(SELECT a.id,a.ftimbrado, CONCAT_WS('/',a.id,a.estatus,a.idcotizacion,g.serie,g.folio,'1',a.odc) AS acciones, c.nombre AS vendedor, b.nombre AS cliente, a.estatus, b.id AS idclientex,
              ...
              AND a.estatus=" . $data_get['estatus'] . "
