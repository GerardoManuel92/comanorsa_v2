...
class AltaMarca extends CI_Controller
{
    ...
    public function altaMarca()
    {
        ...
        if ( $verificar_menu > 0 ) {
            ...
            if($iduser > 0){
                ...
                $titulo = "<i class='fa fa-star'></i> Nueva Marca";

                }else{

                    //// sql de partes

                    $titulo = "<i class='fa fa-edit' style='color:yellow;'></i> Actualizar Marca";
                    

                }

                $data["titulox"]= $titulo;
                $dmenu["nommenu"] = "marcas";
                ...
                $this->load->view('marcas/alta_marca',$data);
                $this->load->view('general/footer');
                $this->load->view('marcas/acciones_alta_marca');
