...

{
    ...
    * @see https://codeigniter.com/user_guide/general/urls.html
...

    {
        ...
        if ( $verificar_menu > 0 ) {
            ...
            if($iduser > 0){
                ...
                $this->load->view('cotizaciones/prueba');

                $this->load->view('general/footer');

                $this->load->view('cotizaciones/acciones_alta_cotizacion');
    ...
    public function copy(){
        ...
        $ruta_actual="tw/js/upload_odc/files/pdf_bdl8675 (1).pdf";

        $ruta_nueva="tw/js/odc_cliente/odc2.pdf";
        ...
        //echo "<a href='../../tw/js/upload_odc/files/pdf_bdl8675.pdf' target='_blank'>prueba</a>";
