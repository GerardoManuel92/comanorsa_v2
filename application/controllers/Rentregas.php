...
class Rentregas extends CI_Controller
...
>>>>>>> ca63c84eed77a5e94e01248e21a910616fd27e73
    ...
    if ($verificar_menu > 0) {
      ...
      if ($iduser > 0) {
        ...
        $this->load->view('entregas/reporte_entregas');

        $this->load->view('general/footer');

        $this->load->view('entregas/acciones_rentregas');
      } else {
...
<<<<<<< HEAD
    ...
    if ($buscar == "" && $estatus == 2) {
      ...
      $table = "(SELECT a.id, a.estatus, a.fecha, CONCAT_WS('',b.serie,b.folio) AS folio, a.idfactura AS factura, d.nombre AS cliente, e.nombre AS entrego, a.recibio AS recibio, a.observaciones,CONCAT_WS('/',a.id,a.estatus) AS acciones 
      ...
      $table = "(SELECT a.id, a.estatus, a.fecha, CONCAT_WS('',b.serie,b.folio) AS folio, a.idfactura AS factura, d.nombre AS cliente, e.nombre AS entrego, a.recibio AS recibio, a.observaciones,CONCAT_WS('/',a.id,a.estatus) AS acciones 
                      ...
                      AND CONCAT_WS(a.idfactura,b.serie, b.folio ,d.nombre,e.nombre) LIKE '%" . $buscar . "%')temp";
    } else if ($buscar != "" && $estatus != 2){
      ...
      $table = "(SELECT a.id, a.estatus, a.fecha, CONCAT_WS('',b.serie,b.folio) AS folio, a.idfactura AS factura, d.nombre AS cliente, e.nombre AS entrego, a.recibio AS recibio, a.observaciones,CONCAT_WS('/',a.id,a.estatus) AS acciones 
                      ...
                      AND CONCAT_WS(a.idfactura,b.serie, b.folio ,d.nombre,e.nombre) LIKE '%" . $buscar . "%'
            ...
            case 0:
              ...
              return '<div class="btn-group">
                                    ...
                                    <span class="caret"></span>
                                      ...
                                      <li><a href="#" data-toggle="modal" data-target="#modalPartidas" style="color:darkblue; font-weight:bold;"> <i class="fa fa-eye" style="color:darkblue; font-weight:bold;"></i> Ver partidas</a></li>

                                        <li><a href="#" style="color:green; font-weight: bold;"><i class="icon-doc-text" style="color:green; font-weight: bold;"></i> Comprobante</a></li>

                                        <li><a href="#" style="color:red; font-weight:bold;"><i class="fa fa-cancel" style="color:red; font-weight:bold;"></i> Cancelar</a></li>
...
=======
    ...
    if ($buscar != "") {
      ...
      $table = "(SELECT a.id, a.estatus, a.fecha, CONCAT_WS('',b.serie,b.folio) AS folio, a.idfactura AS factura, d.nombre AS cliente, e.nombre AS entrego, a.recibio AS recibio, a.observaciones,CONCAT_WS('/',a.id,a.estatus,a.archivo) AS acciones           
                      FROM alta_entrega a, folio_factura b, alta_factura af, alta_clientes d, alta_usuarios e               
                      WHERE a.idfactura=af.id               
                      AND af.idfolio=b.id               
                      AND af.idcliente=d.id               
            ...
            case 0:
              ...
              return '<div class="btn-group">
                                    ...
                                    <span class="caret"></span>
                                      ...
                                      <ul class="dropdown-menu">
                                      <li><a href="#" data-toggle="modal" data-target="#modalPartidas" style="color:darkblue; font-weight:bold;"> <i class="fa fa-eye" style="color:darkblue; font-weight:bold;"></i> Ver partidas</a></li>
                                        <li><a href="' . base_url() . 'tw/js/upload_entrega/files/' . $separar[2] . '" target="_blank" style="color:green; font-weight: bold;"><i class="icon-doc-text" style="color:green; font-weight: bold;"></i> Comprobante</a></li>
                                        <li><a href="#" style="color:red; font-weight:bold;"><i class="fa fa-cancel" style="color:red; font-weight:bold;"></i> Cancelar</a></li>                                      
                                      </ul>
                                    </div>';
...
<<<<<<< HEAD
      ...
      array('db' => 'entrego',     'dt' => 6),



      array('db' => 'recibio',     'dt' => 7),



      array('db' => 'observaciones',     'dt' => 8),
...
>>>>>>> ca63c84eed77a5e94e01248e21a910616fd27e73
  ////////////**************TABLA PARTIDAS MODAL */

  public function loadPartidasxEntrega()

  {
    ...
    if ($identrega > 0) {
      ...
      $table = "(SELECT a.id as id, b.nparte, b.descripcion as producto, c.descripcion as unidad, a.cantidad 
      
<<<<<<< HEAD
                  FROM partes_entrega_factura a, alta_productos b, sat_catalogo_unidades c, partes_cotizacion d, alta_entrega e 
                  
                  WHERE a.idpartecotizacion = d.id 
                  
                  AND a.idpartefactura = b.id 
                  
                  AND a.identrega = e.id 
                  
                  AND b.idunidad = c.id 
                  
                  AND e.id = '".$identrega."')temp";
=======
      FROM partes_entrega_factura a, alta_productos b, sat_catalogo_unidades c, partes_cotizacion d 
      ...
      AND a.identrega = '".$identrega."')temp";
>>>>>>> ca63c84eed77a5e94e01248e21a910616fd27e73
    } 
