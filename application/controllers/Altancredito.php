...
class Altancredito extends CI_Controller
{
    ...
    public function showFactura(){
        ...
        if ( $verificar_menu > 0 ) {
            ...
            if($iduser > 0){
                ...
                ///////*** 
                $sql = "SELECT a.id, b.nombre AS cliente, b.comercial, a.total, CONCAT_WS('',c.serie,c.folio) AS folio, a.moneda, a.tcambio, a.idcotizacion
                ...
                $data_user['iduserx'] = $iduser;
                    ...
                    $this->load->view('nota_credito/body_nota',$data);
                    $this->load->view('general/footer');
                    $this->load->view('nota_credito/acciones_body_nota',$data_user);
