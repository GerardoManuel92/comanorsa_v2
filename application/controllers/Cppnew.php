...
class Cppnew extends CI_Controller
{
    ...
    * @see https://codeigniter.com/user_guide/general/urls.html
    ...
    public function index()
    {
        ...
        if ( $verificar_menu > 0 ) {
            ...
            if($iduser > 0){
                ...
                $this->load->view('ppd/body_ppdv3');
                $this->load->view('general/footer');
                $this->load->view('ppd/acciones_ppdv3',$data);
    ...
    public function showCuentas(){
        ...
        $query="SELECT a.id,a.cuenta,b.comercial
    ...
    public function showMovimientos(){
        ...
        $query="SELECT a.fecha_banco,a.hora_banco,a.id,a.rastreo,b.cuenta,c.comercial,a.importe
    ...
    public function datosCuentas(){
        ...
        $query='SELECT b.razon,b.rfc,a.cuenta 
        FROM cuentas_bancariasxcliente a, alta_bancos b
        WHERE 
        a.idbanco=b.id
        AND a.id='.$data_post["idcuentax"];
    ...
    public function datosMovimiento(){
        ...
        $query='SELECT a.id,a.rastreo,a.fpago,b.cuenta,a.importe,a.fecha_banco,c.rfc,c.razon,d.cuenta AS cuenta_empresa,e.rfc AS rfc_banco_empresa
                FROM saldo_bancos a, cuentas_bancariasxcliente b, alta_bancos c,alta_cuentas_comanorsa d, alta_bancos e
                WHERE a.idcuenta=b.id
                AND b.idbanco=c.id
                AND a.idcuenta_empresa=d.id
                AND d.idbanco=e.id
                AND a.estatus=0
                AND a.id='.$data_post["idmov"].' LIMIT 0,1';
