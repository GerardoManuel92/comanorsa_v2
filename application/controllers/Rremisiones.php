...
class Rremisiones extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ( $verificar_menu > 0 ) {
          ...
          if($iduser > 0){
              ...
              $nom_menu["nommenu"] = "rremision";

              $this->load->view('general/header');
              $this->load->view('general/menuv2');
              $this->load->view('general/css_datatable');
              $this->load->view('general/menu_header',$nom_menu);
              $this->load->view('remisiones/reporte_remisiones');
              $this->load->view('general/footer');
              $this->load->view('remisiones/accciones_reporte_remisiones');
    ...
    public function enviarCorreo(){
        ...
        $otro_correox = $data_post["otro_correo"];
                ...
                $mensaje = '<!DOCTYPE html>
                    ...
                    $this->email->from(CORREOVENTAS, 'Remision #'.$idcotx.' - Comanorsa | Comercializadora angel de oriente S.A. DE C.V.');
                    ...
                    $this->email->attach('tw/php/remisiones/rem'.$idcotx.'.pdf');
    ...
    ///////////****************TABLA PARTIDAS BITACORA
        ...
        public function loadPartidas()
        {
            ...
            $table = "(SELECT a.id, CONCAT_WS('/',a.fecha, a.hora) AS dia,a.pago,c.nombre AS vendedor,d.nombre AS cliente,b.subtotal,b.descuento,b.iva,b.total,a.estatus,
            ...
            $columns = array(
                            ...
                            */
                            ...
                            switch ($separar[1]) {
                                ...
                                case 0:
                                    ...
                                    <span class="caret"></span>
                                      ...
                                      <ul class="dropdown-menu">
                                        ...
                                        <li><a href="javascript:cambiarEstatus('.$separar[0].',1)" target="_blank" style="color:red; font-weight:bold;"><i class="fa fa-cancel" style="color:red; font-weight:bold;"></i> Declinar</a></li>
                               ...
                               case 1:
                                    ...
                                    return '<a class="btn btn-success" href="javascript:cambiarEstatus('.$separar[0].',0)" role="button" ><i class="fa fa-check" title="Activar remision" style="color:white;"></i></a>';
                ...
                array( 'db' => 'id',     'dt' => 4,
                        ...
                        'formatter' => function( $d, $row ) {
                            ...
                            return '<a href="'.base_url().'tw/php/remisiones/rem'.$d.'.pdf" target="_blank">'.$d.'</a>';
