				...
				<div class="panel panel-default" style="border-color: <?php //echo BGCOLOR ?>; border-width: 1.5px; border-style: solid; background-color: <?php //echo BGCOLORDEGRADE; ?>" >
					...
					<div class="row">
						...
						<div class="col-md-3 col-lg-3" style="margin-top:27px;">
							...
							<button class="btn btn-success" id="btn_asignar" onclick="asignarPartidas()">Realizar Requerimiento</button>
							<button class="btn btn-danger" id="btn_finalizar" onclick="finalizarAsg()">Finalizar</button>
															...
															<table class="table table-striped table-bordered table-hover" id="my-table" >
																...
																<thead class="bg-thinkweb-table" style="background-color: gray; color: white;">
																	...
																	<tr>
																		...
																		<th style="font-weight: bold; min-width: 150px;">Clave</th>

																		<th style="font-weight: bold; min-width: 300px;">Producto</th>

																		<th style="font-weight: bold; min-width: 50px; text-align: center;">Pedido</th>

																		<th style="font-weight: bold; min-width: 50px; text-align: right;">Solicitado a ODC</th>

																		<th style="font-weight: bold; min-width: 50px; text-align: center;">Asigado de almacen</th>

																		<th style="font-weight: bold; min-width: 50px; text-align: right;">Requerido</th>																																				

																		<th style="font-weight: bold; min-width: 50px; text-align: right;">Solicitar</th>																		
