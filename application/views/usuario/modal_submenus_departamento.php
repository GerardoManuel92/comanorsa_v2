<style>
    #modalSubmenus {
        max-height: 95%;
        overflow-y: auto;
        /* Habilitar el scroll vertical si es necesario */
    }

    .modal-body {
        max-height: calc(95% - 120px);
        /* Ajustar según la altura de la cabecera y el pie de página */
        overflow-y: auto;
        /* Habilitar el scroll vertical si es necesario */
    }
...
<div id="modalSubmenus" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="success-header-modalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row" style="margin: auto;">
                    ...
                    <div class="col-md-3 col-lg-3">
                        ...
                        <div class="input-group flex-nowrap">
                            ...
                            <button class="btn btn-info" type="button" onclick="AgregaNvoSubmenu();"><i class="ri-add-fill" style="font-weight: bold;"></i></button>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal" id="cerrar_modaly">Cerrar</button>
