...
<div class="row" >
				...
				<div class="col-md-9 col-lg-9 col-xs-12">
						...
						<div class="col-md-4 col-lg-4 col-sm-6 col-xs-12"> 
							...
							<label>*Folio</label>
									...
									<div class="input-group"> 
										...
										<input type="text" class="form-control" id="folio"  autofocus > 

										<span class="input-group-btn"><button class="btn btn-warning" type="button" onclick="showInfo()"><i class="fa fa-search" style="color:black;"></i></button></span>
						...
						<div class="col-md-2" style="display: none;">
							...
							<input type="number" name="tipo_factura" id="tipo_factura" disabled>
															...
															<table class="table table-striped table-bordered table-hover" id="my-table" >
																...
																<thead class="bg-thinkweb-table" style="background-color: gray; color: white;">
																	...
																	<tr>
																		...
																		<th style="font-weight: bold; min-width: 60px; text-align: center; font-size: 12px;">Entregado</th>

																		<th style="font-weight: bold; min-width: 60px; text-align: right; font-size: 12px;">
																		Por entregar</th>
