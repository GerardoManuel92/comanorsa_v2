...
<script type="text/javascript" src="<?php echo base_url(); ?>tw/js/jzip/jszip.js">></script>
<script type="text/javascript" src="<?php echo base_url(); ?>tw/js/jzip/FileSaver.js">></script>
...
<script src="<?php echo base_url(); ?>tw/js/com_factura/reporte_factura.js?v=<?php echo time();?>"></script>
