				...
				<div class="col-md-9 col-lg-9">
					...
					<div class="col-md-12">
		      		...
		      		<div class="col-md-2">
		      			...
		      			<a style="color:red; font-weight: bold;" href="<?php echo base_url()?>tw/php/cotizaciones/cot<?php echo $info->idcotizacion; ?>.pdf" target="_blank"><i class="fa fa-file-text"></i> 

		      				<?php

		      				//////////************** CREAR FOLIO ODV0010000
                              $idcotx = $info->idcotizacion;
                              $folio = 0;
                              $inicio = 10000;
                              $nuevo = $inicio+$idcotx;
		      		...
		      		<input type="number" name="idcliente" id="idcliente" disabled hidden value="<?php echo $info->idcliente; ?>">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success" onclick="facturarXml()" id="btnfactura"><i class="fa fa-check"> Facturar</i></button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
