				...
				<div class="col-md-9 col-lg-9">
					...
					<div class="col-md-12">
		      		...
		      		<div class="col-md-2">
		      			...
		      			<a style="color:red; font-weight: bold;" href="<?php echo base_url()?>tw/php/cotizaciones/cot<?php echo $idcot; ?>.pdf" target="_blank"><i class="fa fa-file-text"></i> 
      ...
      <div class="modal-body">
      	...
      	<div class="row">
      		...
      		<div class="col-md-3" style="margin-top: 10px;">
      			...
      			<input type="text" name="odc" id="odc" class="form-control">
      	...
      	<div class="row">
      		...
      		<div class="col-md-12">
      			...
      			<textarea class="form-control" id="obs" rows="obs" name="obs"></textarea>
