	...
	<div class="col-md-10 col-lg-10 col-xs-12">
		...
		<div class="row">
			...
			<div class="col-md-2 col-lg-2">
				...
				<input type="text" name="name_archivo" id="name_archivo" class="form-control" placeholder="Comprobante..." tabindex="3" disabled style="display: none;">
		...
		<div class="row" style="margin-top: 15px;">
			...
			<div class="col-md-1 col-lg-1">
				...
				<!--<input type="text" name="unidad" class="form-control" id="unidad" placeholder="UM..." disabled>-->
