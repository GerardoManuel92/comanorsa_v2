<div class="row">
	...
	<div class="col-md-4 col-lg-4">
		...
		<select name="usuario" id="usuario" class="form-control select2-placeholer" placeholder="seleccionar cliente p/cotizacion..." onchange="showInfo()" style="font-size: 12px;"></select>
		...
		<table class="table table-striped table-bordered table-hover" id="my-table">
			...
			<thead class="bg-thinkweb-table" style="background-color: gray; color: white;">
				...
				<tr>
					...
					<th style="font-weight: bold; min-width: 70px; text-align: center;">Folio</th>

					<th style="font-weight: bold; min-width: 200px; text-align: left;">Motivo</th>

					<th style="font-weight: bold; min-width: 100px; text-align: left;">RETIRÓ</th>

					<th style="font-weight: bold; min-width: 80px; text-align: right;">Total</th>

					<th style="font-weight: bold; min-width: 80px; text-align: right;">Documento</th>
