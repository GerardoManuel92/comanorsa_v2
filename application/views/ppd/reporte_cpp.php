<div class="row">
	...
	<div class="col-md-4 col-lg-4">
		...
		<label>Buscar por cliente/empresa/total/NC/folio_factura/UUID/:</label>
	...
	<div class="col-md-4 col-lg-4">
		...
		<select class="form-control" name="bestatus" id="bestatus" onchange="loadFiltroAll();">
			...
			<option value="5" style="font-weight: bold;" selected>Todos...</option>

			<option value="0" style="color:#FFA500; font-weight: bold;">Sin timbrar</option>

			<option value="1" style="color:green; font-weight: bold;">Facturadas</option>

			<option value="2" style="color:red; font-weight: bold;">Canceladas</option>
	...
	<!--<button class="btn btn-primary" data-toggle="modal" data-target="#modal_cancelar" >Abrir ventana</button>-->
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="background-color: #5682b6; color: white; font-weight: bold;">
				...
				<h4 class="modal-title" style="font-weight: bold;" id="titulo">Enviar nota de credito</h4>
			</div>
...
<div id="modal_cancelar" class="modal fade" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header" style="background-color: #5682b6; color: white; font-weight: bold;">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" style="font-weight: bold;" id="titulo">Cancelar nota de credito</h4>
			</div>
			<div class="modal-body">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-danger" onclick="cancelarFact()" id="btn_cancelar"> Cancelar Nota</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
		...
		<table class="table table-striped table-bordered table-hover" id="my-table">
			...
			<thead class="bg-thinkweb-table" style="background-color: gray; color: white;">
				...
				<tr>
					...
					<th style="font-weight: bold; min-width: 60px; text-align: center;">Nota</th>
