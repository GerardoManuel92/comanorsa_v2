    ...
    <div class="col-md-10 col-lg-10">
        ...
        <div class="row">
            ...
            <!--<div class="col-md-12 col-lg-12">
                ...
                <label>*Selecciona la cuenta del cliente</label>
                <select class="form-control" id="lista_cuentas" name="lista_cuentas" onchange="datosCuentas(this.value)" tabindex="2"></select>

            </div>-->

            <label>*Selecciona EL MOVIMIENTO bancario</label>
            <select class="form-control" id="lista_movimiento" name="lista_movimiento" onchange="datosMovimiento(this.value)" tabindex="2"></select>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3" style="margin-top: 10px;">
                ...
                <select class="form-control" id="fpago" tabindex="3" disabled></select>
            ...
            <div class="col-md-3 col-lg-3" style="margin-top: 10px;">
                ...
                <input type="text" name="noperacion" id="noperacion" class="form-control" tabindex="4" disabled>
            ...
            <div class="col-md-2 col-lg-2" style="margin-top: 10px;">
                ...
                <label>Fecha</label>
                <input type="date" name="fecha" id="fecha" class="form-control" tabindex="5">
            ...
            <div class="col-md-3 col-lg-3" style="margin-top: 10px;">
                ...
                <label>RFC</label>
                <input type="text" name="rfc" id="rfc" class="form-control" tabindex="6" disabled>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3" style="margin-top: 10px;">
                ...
                <label>Banco</label>
                <input type="text" name="banco" id="banco" class="form-control" tabindex="7" disabled>
            ...
            <div class="col-md-3 col-lg-3" style="margin-top: 10px;">
                ...
                <label>Cuenta</label>
                <input type="text" name="cuenta" id="cuenta" class="form-control" tabindex="8" disabled>
            ...
            <div class="col-md-3 col-lg-3" style="margin-top: 10px;">
                ...
                <input type="text" name="brfc" id="brfc" class="form-control" tabindex="9" value="BBA940707IE1" disabled>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3" style="margin-top: 10px;">
                ...
                <input type="text" name="bcuenta" id="bcuenta" class="form-control" tabindex="10" value="030180900007074540" disabled>
            ...
            <div class="col-md-2 col-lg-2" style="margin-top: 10px; text-align: right;">
                ...
                <label>Importe</label>
                <input type="number" name="importe" id="importe" class="form-control" tabindex="11" disabled style="text-align:right;">

            </div>


                                <div class="col-md-5 col-lg-5" style="margin-top: 10px;"> 
                                    <!-- ADJUNTAR FIANZA-->
