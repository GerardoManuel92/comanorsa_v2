...
<script type="text/javascript">
	...
	var idclientex =  "<?php echo $info->idcliente ?>";

	var idcotx = "<?php echo $idcot ?>";

	var idmonedax = "<?php echo $info->moneda ?>";

	var idfpagox = "<?php echo $info->idfpago ?>";

	var idcfdix = "<?php echo $info->idcfdi ?>";

	var idodcx = "<?php echo $info->odc; ?>";



	///// bloquear la actualizacion 
	...
	/*if ( idodcx == 1 ) {
		...
		$("#btn_finalizaract").css("display","none");
	...
	//$("#moneda").val(idmonedax);



</script>

<script src="<?php echo base_url(); ?>tw/js/com_cotizaciones/prueba_actualizacion_cotizacion.js?v=<?php echo time();?>"></script>
...
<script type="text/javascript">
	...
	$("#cliente").val(idclientex);



	//alert("version 2.0"+" "+idclientex );
