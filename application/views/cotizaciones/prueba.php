...
<div class="row" >
					...
					<div class="row">
							...
							<div class="col-md-8 col-lg-8"> 
								...
								<div class="input-group"> 
										...
										<select  name="cliente" id="cliente" class="form-control select2-placeholer" placeholder="seleccionar cliente p/cotizacion..." tabindex="1"  style="font-size: 12px;"></select>
				...
				<div class="col-md-2 col-lg-2 col-xs-12" style="text-align: right;">
	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-footer">
	        ...
	        <button type="button" class="btn btn-success" onclick="finalizarCotizacion(1)">Crear pedido</button>
